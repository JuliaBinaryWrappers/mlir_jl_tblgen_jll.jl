# `mlir_jl_tblgen_jll.jl` (v0.0.6+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ffc2f645ca6cf79ff7132a1a69881d288deefc48/M/mlir_jl_tblgen/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaLabs/MLIR.jl.git (revision: `3527e24046b808a6224ff700e373e9f6dc46e86b`)
